...
would allow a simple ‘kubectl create ...’ to deploy the application - **in our case we have created a helm chart to deploy docker image to cluster from local copy of repo- from root dir of repo, e.g. you may run `helm upgrade test-release ./challenge --namespace default`**
